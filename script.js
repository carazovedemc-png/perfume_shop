...
const PRODUCTS_DATA = [
    ...
    },
    {
        id: 3,
        name: "Black Opium",
        description: "«BLACK OPIUM»-женские духи из группы «восточные гурманские». Композиция глубокая, насыщенная, сладкая и притягательная. Верхние ноты: груша, розовый перец и цветок апельсина. Средние ноты: кофе, жасмин, горький миндаль и лакричник. Базовые ноты: ваниль, пачули, кедр и кашемировое дерево.",
        price: 350,
        oldPrice: 0,
        category: "affordable",
        volume: 6,
